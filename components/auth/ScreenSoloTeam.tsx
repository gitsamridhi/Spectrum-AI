    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 pt-2">
        <button onClick={() => handleSelectType("solo")}
          ...
          <div className={`p-3 rounded-full mb-3 ${answers.workspaceType === "solo" ? "bg-orange-100" : "bg-zinc-100"}`}>
            <User className={`w-5 h-5 ${answers.workspaceType === "solo" ? "text-orange-500" : "text-zinc-500"}`} />
          </div>
          <span className={`text-[13px] font-bold block ${answers.workspaceType === "solo" ? "text-orange-900" : "text-zinc-900"}`}>Solo Workspace</span>
          <span className={`text-[11px] mt-1 ${answers.workspaceType === "solo" ? "text-orange-600/70" : "text-zinc-400"}`}>Just me — personal projects</span>
        </button>
        ...
        <button onClick={() => handleSelectType("team")}
          ...
          <div className={`p-3 rounded-full mb-3 ${answers.workspaceType === "team" ? "bg-orange-100" : "bg-zinc-100"}`}>
            <Users className={`w-5 h-5 ${answers.workspaceType === "team" ? "text-orange-500" : "text-zinc-500"}`} />
          </div>
          <span className={`text-[13px] font-bold block ${answers.workspaceType === "team" ? "text-orange-900" : "text-zinc-900"}`}>Team Workspace</span>
          <span className={`text-[11px] mt-1 ${answers.workspaceType === "team" ? "text-orange-600/70" : "text-zinc-400"}`}>With others — shared creative hub</span>
        </button>
      </div>
